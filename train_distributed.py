...
from configs.train_config_distributed import get_arguments
...
def main():
    ...
    train_dataset = cityscapesDataSet(args, args.data_dir, args.data_list,
                                      max_iters=args.num_steps * args.iter_size * args.batch_size,
                                      set=args.set)
    target_dataset = zurich_pair_DataSet(args, args.data_dir_target, args.data_list_target,
                                         max_iters=args.num_steps * args.iter_size * args.batch_size,
                                         set=args.set)
    ...
    trainloader = data.DataLoader(
        train_dataset,
        batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, pin_memory=True, sampler=train_sampler)
    trainloader_iter = enumerate(trainloader)

    targetloader = data.DataLoader(target_dataset,
                                   batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers,
                                   pin_memory=True, sampler=target_sampler)
